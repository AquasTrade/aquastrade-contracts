...
// TODO (burner and minter roles)
// TODO: Set max supply for liquidity mining rewards (MasterChef minting cap)
// TODO: Separate the minting functions (one for MasterChef and one for the TokenManager)
contract RubyTokenSkale is SkaleMappedERC20Token("RubyToken", "RUBY", 18) {
    /// @notice Total number of tokens
    uint256 public rubyMintedOnMainnet = 1_000_000e18; //
    /// @notice Total number of tokens
    ...
    function mint(address to, uint256 amount) public override {
        ...
        require(totalSupply().add(amount) <= maxSupply, "RUBY::mint: Cannot exceed max supply.");
        _mint(to, amount);

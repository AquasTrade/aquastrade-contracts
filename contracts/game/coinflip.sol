...
import "@openzeppelinV2/contracts/utils/math/SafeMath.sol";
import "@openzeppelinV2/contracts/token/ERC20/utils/SafeERC20.sol";
...
contract coinflip {
    ...
    function flipCoin(uint256 _betAmount) public {
        require(_betAmount >= minBet);
        require(_betAmount <= maxBet);

        //SafeERC20.safeTransfer(underlying, account, amount);
        //        SafeERC20.safeTransferFrom(underlying, _msgSender(), address(this), amount);
        SafeERC20.safeTransfer(IERC20(address(PayToken)), address(this), _betAmount);
    ...
    function WithdrawAll() public {
        ...
        require(IERC20(address(PayToken)).balanceOf(address(this)) >= amount, " CoinFlip out of funds");

        SafeERC20.safeTransferFrom(IERC20(address(PayToken)), address(this), msg.sender, amount);

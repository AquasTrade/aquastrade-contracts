...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  // Check roles
  console.log("TokenManagerErc20 has MINTER_ROLE_IMA:", (await tokenContract.hasRole(minterRole, tokenManagerErc20Address)))
  console.log("TokenManagerErc20 has BURNER_ROLE_IMA:", (await tokenContract.hasRole(burnerRole, tokenManagerErc20Address)))

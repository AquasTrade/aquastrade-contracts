//yarn deploy --network stagingv3 --tags EuropaTGOLD
...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  const tokenContract = await ethers.getContract("EuropaTGOLD");
...
func.tags = ["EuropaTGOLD", "MappedTokens", "PartnerTokens"];

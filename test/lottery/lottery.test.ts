...
describe("Lottery Factory contract", function() {
    ...
    describe("Creating a new lottery tests", function() {
        ...
        it("Nominal case", async function() {
            ...
            await expect(
                this.factoryInstance.connect(this.owner).createNewLotto(this.rubyInstance.address, this.nftInstance.address, 1, lotto.setup.sizeOfLottery, lotto.newLotto.cost, lotto.newLotto.distribution, lotto.newLotto.day)
        ...
        it("Invalid admin", async function() {
            await expect(
                this.factoryInstance.connect(this.buyer).createNewLotto(this.rubyInstance.address, this.nftInstance.address, 1, lotto.setup.sizeOfLottery, lotto.newLotto.cost, lotto.newLotto.distribution, lotto.newLotto.day)
        ...
        it("Multiple case", async function() {
            ...
            // Creating a new lottery
            await expect(
                this.factoryInstance.connect(this.owner).createNewLotto(this.rubyInstance.address, this.nftInstance.address, 2, lotto.setup.sizeOfLottery, lotto.newLotto.cost, lotto.newLotto.distribution, lotto.newLotto.day)
            ).to.emit(this.factoryInstance, lotto.events.new)
            // Checking that emitted event contains correct information
            .withArgs(
                1
            ...
            await expect(
                this.factoryInstance.connect(this.owner).createNewLotto(this.rubyInstance.address, this.nftInstance.address, 3, lotto.setup.sizeOfLottery, lotto.newLotto.cost, lotto.newLotto.distribution, lotto.newLotto.day)
            ).to.emit(this.factoryInstance, lotto.events.new)
            // Checking that emitted event contains correct information
            .withArgs(
                2
        ...
        it("Multiple case(different NFT Collection)", async function() {
            ...
            await expect(
                this.factoryInstance.connect(this.owner).createNewLotto(this.rubyInstance.address, nftInstance1.address, 1, lotto.setup.sizeOfLottery, lotto.newLotto.cost, lotto.newLotto.distribution, lotto.newLotto.day)
            ).to.emit(this.factoryInstance, lotto.events.new)
            // Checking that emitted event contains correct information
            .withArgs(
                2
    ...
    describe("Buying tickets tests", function() {
        ...
        beforeEach( async function () {
            await this.nftInstance.connect(this.owner).approve(this.factoryInstance.address, 1);
            await this.factoryInstance.connect(this.owner).createNewLotto(this.rubyInstance.address, this.nftInstance.address, 1, lotto.setup.sizeOfLottery, lotto.newLotto.cost, lotto.newLotto.distribution, lotto.newLotto.day)
